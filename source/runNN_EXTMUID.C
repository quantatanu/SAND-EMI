...
void runNN_EXTMUID(TString infile){
  ...
  TString input_path = "/pnfs/dune/persistent/users/anath/EXTMUID_ANALYSIS/ROOT/NNINPUT/";
  TString output_path = "/pnfs/dune/persistent/users/anath/EXTMUID_ANALYSIS/ROOT/NNOUTPUT/";
...
//--------------------------------------------------------------------------------------------
  ...
  TMultiLayerPerceptron *mlp = new TMultiLayerPerceptron
    //("@P,@extmuidlen,@E,@cellEmax,@cellNtot,@cellEmin,@cellEavg,@cellEr,@layerEmean,@layerErms,@layerEr,@layerEL0,@layerEmax,@layerEmin,@layerNcellL0,@layerNcellmax,@layerNcellmin,@layerNcellr,@layerNcellmean:18:type", nntree, "Entry$%2", "(Entry$+1)%2");
    ...
    //("@cellEmax,@cellEmin,@cellEavg,@layerEmean,@layerEr,@layerEL0,@layerNcellL0,@layerNcellmean:7:3:type", nntree, "Entry$%2", "(Entry$+1)%2");
    //("@cellEmax,@cellEmin,@layerEmean,@layerEr,@layerEL0,@layerNcellL0,@layerNcellmean:6:2:type", nntree, "Entry$%2", "(Entry$+1)%2");
